...
void Special::createText(int id, std::string text, std::vector<float>& intersections, std::vector<int>& connectionsA, std::vector<int>& connectionsB,
	...
	std::map<char, std::vector<int>> coords = {
		{ 'a',{ 6,0,2,8,5,3 } },{ 'c',{ 2,0,6,8 } },{ 'd',{ 0,1,5,7,6,0 } },{ 'e',{ 2,0,3,5,3,6,8 } },{ 'f',{ 2,0,3,5,3,6} }, { 'g',{ 2,0,6,8,5,4 } },{ 'i',{ 0,2,1,7,6,8 } },{ 'k',{ 0,6,3,2,3,8 } },
		{ 'l',{ 0,6,8 } },{ 'm',{ 6,0,4,2,8 } },{ 'n',{ 6,0,8,2 } },{ 'o',{ 0,2,8,6,0 } },{ 'p',{ 6,0,2,5,3 } },{ 'r',{ 6,0,2,5,3,8 } },{ 's',{ 2,0,3,5,8,6 } },
		{ 't',{ 0,2,1,7 } },{ 'u',{ 0,6,8,2 } },{ 'v',{ 0,7,2} },{ 'x',{ 0,8,4,2,6 } },{ 'y',{ 0,4,7,4,2 } },{ '0',{ 0,2,8,6,0 } },{ '1',{ 0,1,7,6,8 } },{ '2',{ 0,2,5,3,6,8 } },{ '3',{ 0,2,5,3,5,8,6 } },
...
void Special::drawSeedAndDifficulty(int id, int seed, bool hard, bool setSeed, bool options)
{
	...
	createText(id, hard ? "inferno" : "variety", intersections, connectionsA, connectionsB, 0.1f, 0.9f, 0.25f, 0.4f);
...
void Special::drawGoodLuckPanel(int id)
{
	...
	std::vector<int> connectionsA;
	std::vector<int> connectionsB;
	createText(id, "good luck!", intersections, connectionsA, connectionsB, 0.025f, 1.1f, 0.07f, 0.25f);
	createText(id, "player one!", intersections, connectionsA, connectionsB, 0.025f, 1.1f, 0.77f, 0.93f);
